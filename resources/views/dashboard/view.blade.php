<div class="modal fade" id="view_active{{$visitor->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-10">
                        <label class="col-form-h4">Purpose:</label>
                        <label class="col-form-h4" style="font-weight: 500">&nbsp;{{ $visitor->purpose }}
                        </label>
                    </div>
                    <div class="col-md-6 mb-10">
...
<div class="modal fade" id="view_return{{$visitor->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel">Visitor Information</h3>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-10">
                        <label class="col-form-h4">Date Exited:</label>
                        <label class="col-form-h4" style="font-weight: 500">&nbsp;{{$visitor->updated_at->format('m/d/Y - h:i:s A')}}
                        </label>
                    </div>
                </div>
                <div class="row">
